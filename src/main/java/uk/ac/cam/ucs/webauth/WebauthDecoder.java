...
/**
 * Implements a decoder for encoded binary strings as used by the authentication
 * system. The encoding scheme is actually just BASE64 as defined in RFC 1521,
 * except that the characters '+', '/', and '=' are replaced by '-', '.' and '_'
 * to reduce the URL-encoding overhead.
 * 
...
public class WebauthDecoder {
	 ...
	 * 
	 * @param encoded
	 *            the encoded string for processing
	 * 
	 * @return the decoded data
	 * 
	 * @throws IOException
	 *             if the encoded string is malformed
	 */
